                              ...
                              <figure class="sitemap-horizontal">
                                    <ul class="administration">
                                          <li>
                                                <ul class="director">
                                                      <li>
                                                            <a href="javascript:void(0);" class="fw-semibold"><span>lionsclubs Admin</span></a>
                        ...
                        <div class="row">
                                          ...
                                          <ul class="list-unstyled mb-0">
                                                ...
                                                <li>
                                                      <div class="first-list">
                                                            <div class="list-wrap">
                                                                  <a href="javascript: void(0);" class="fw-medium text-primary">Erica Kernan
                                                                        - Team Leader</a>
                                                            </div>
                                                      ...
                                                      <div class="first-list">
                                                            <div class="list-wrap">
                                                                  <a href="javascript: void(0);" class="fw-medium text-primary">Mary Jones -
                                                                        Project Manager</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                      ...
                                                      <div class="first-list">
                                                            <div class="list-wrap">
                                                                  <a href="javascript: void(0);" class="fw-medium text-primary">Tilly Kent -
                                                                        Executive Manager</a>
                                                            </div>
                                                            <ul class="second-list list-unstyled">
                                                                  <li>
                                                      ...
                                                      <div class="first-list">
                                                            <div class="list-wrap">
                                                                  <a href="javascript: void(0);" class="fw-medium text-primary">Rachel Rose
                                                                        - HR</a>
                                                            </div>
                                                      </div>
                                                </li>
                              ...
                              <div class="col-sm-6">
                                    <div class="verti-sitemap">
                                          <ul class="list-unstyled mb-0">
                                                <li class="p-0 parent-title"><a href="javascript: void(0);"
                                                                                class="fw-medium fs-14">lionsclubs</a></li>
                                                <li>
                                                      <div class="first-list">
                                                            <div class="list-wrap">
