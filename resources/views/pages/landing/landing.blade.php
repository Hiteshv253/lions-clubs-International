                ...
                <div class="col-lg-8 col-sm-10">
                    <div class="text-center mt-lg-5 pt-5">
                        <h1 class="display-6 fw-semibold mb-3 lh-base">The better way to manage your website with <span
                                class="text-success">lionsclubs </span></h1>
                        <p class="lead text-muted lh-base">lionsclubs is a fully responsive, multipurpose and premium Bootstrap 5
    ...
    <section class="py-5 bg-primary position-relative">
        ...
        <div class="container">
            <div class="row align-items-center gy-4">
                <div class="col-sm">
                    <div>
                        <h4 class="text-white mb-0 fw-semibold">Build your web App/SaaS with lionsclubs dashboard</h4>
                    </div>
                </div>
                <!-- end col -->
                <div class="col-sm-auto">
                    <div>
                        <a href="https://1.envato.market/lionsclubs-admin" target="_blank"
