                                    ...
                                    <div class="row g-4">
                                          <div class="col-md-4">
                                                <div class="card shadow-sm border-0">
                                                      <div class="card-body">
                                                            <h6 class="card-title"><i class="fas fa-calendar-alt me-2 text-primary"></i> My Events</h6>
                                          ...
                                          <div class="col-md-4">
                                                <div class="card shadow-sm border-0">
                                                      <div class="card-body">
                                                            <h6 class="card-title"><i class="fas fa-id-card me-2 text-success"></i> Membership Status</h6>
                                          ...
                                          <div class="col-md-4">
                                                <div class="card shadow-sm border-0">
                                                      <div class="card-body">
                                                            <h6 class="card-title"><i class="fas fa-user me-2 text-info"></i> My Profile</h6>
                                          ...
                                          <div class="col-12">
                                                ...
                                                <div class="d-flex flex-wrap gap-3">
                                                      ...
                                                      <a href="{{ route('profile.profile_our_member') }}" class="btn btn-outline-secondary">
                                                            <i class="fas fa-cogs me-1"></i> Browse Members
                                                      </a>
                                                </div>
                                          </div>
                                    </div>
