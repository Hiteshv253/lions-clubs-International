        ...
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="apps-nft-explore.html" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="d-lg-flex align-items-center mb-4">
                ...
                <div class="flex-shrink-0 mt-4 mt-lg-0">
                    <a href="apps-nft-creators.html" class="btn btn-soft-primary">View All <i
                            class="ri-arrow-right-line align-bottom"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col">
            <div class="card">
                ...
                <div class="card-body text-center">
                    ...
                    <h5 class="mt-3 mb-1"><a href="pages-profile.html">Tonya Noble</a></h5>
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="assets/images/nft/img-04.jpg" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="pages-profile.html">Kevin Dawson</a></h5>
            ...
            <div class="card">
                ...
                <div class="card-body text-center">
                    <img src="assets/images/nft/img-06.jpg" alt=""
                        class="avatar-md mt-n5 rounded-circle mx-auto d-block object-fit-cover">
                    <h5 class="mt-3 mb-1"><a href="pages-profile.html">Herbert Stokes</a></h5>
