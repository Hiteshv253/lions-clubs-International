                                                ...
                                                <td class="collection">
                                                      <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/img-01.jpg" alt=""
                                                                 ...
                                                                 href="apps-nft-item-details.html" class="text-body">Abstract Face
                                                                  Painting</a>
                                                      </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                      <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/img-02.jpg" alt=""
                                                                 class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                                 href="apps-nft-item-details.html" class="text-body">Creative Filtered
                                                                  Portrait</a>
                                                      </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                      <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/img-04.jpg" alt=""
                                                                 class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                                 href="apps-nft-item-details.html" class="text-body">Robotic Body Art</a>
                                                      </div>
                                                </td>
                                                ...
                                                <td class="collection">
                                                      <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/img-06.jpg" alt=""
                                                                 class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                                 href="apps-nft-item-details.html" class="text-body">Smillevers Crypto</a>
                                                      </div>
                                                </td>
                                          ...
                                          <tr>
                                                ...
                                                <td class="collection">
                                                      <div class="d-flex align-items-center">
                                                            <img src="assets/images/nft/img-04.jpg" alt=""
                                                                 class="avatar-xs rounded-circle object-fit-cover me-2"> <a
                                                                 href="apps-nft-item-details.html" class="text-body">Highstreet IHO
                                                                  Part</a>
                                                      </div>
                                                </td>
