                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Abstract Face Painting</a></h6>
                                    <div>
                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Patterns Arts & Culture</a></h6>
                                    <div>
                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-40">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Creative Filtered Portrait</a>
                                    </h6>
                                    <div>
                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Smillevers Crypto</a></h6>
                                    <div>
                        ...
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                          47.12k </p>
                                    <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Long-tailed Macaque</a></h6>
                                    <div>
                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-15">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">The Chirstoper</a></h6>
                                    <div>
                  ...
                  <div class="col-xxl-3 col-lg-4 col-md-6 product-item upto-30">
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    ...
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Robotic Body Art</a></h6>
                                    <div>
                        ...
                        <div class="card explore-box card-animate">
                              ...
                              <div class="card-body">
                                    <p class="fw-medium mb-0 float-end"><i class="mdi mdi-heart text-danger align-middle"></i>
                                          94.1k </p>
                                    <h5 class="text-success"><i class="mdi mdi-ethereum"></i> 245.23ETH </h5>
                                    <h6 class="fs-16 mb-3"><a href="apps-nft-item-details.html">Evolved Reality</a></h6>
                                    <div>
