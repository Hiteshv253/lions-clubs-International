      ...
      <div class="row">
            <div class="col-12">
                  <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0">Welcome  {{ Auth::user()->first_name }} {{ Auth::user()->last_name }}</h4>

                        <div class="page-title-right">
                              <ol class="breadcrumb m-0">
                                    <li class="breadcrumb-item"><a href="javascript: void(0);">Dashboards</a></li>
                                    <li class="breadcrumb-item active">Lions International</li>
                              </ol>
                        </div>
                  ...
                  <div class="card crm-widget">
                        <div class="card-body p-0">
                              <div class="row row-cols-xxl-5 row-cols-md-3 row-cols-1 g-0">
                                    <div class="col">
                                          <div class="py-4 px-3">
                                                <h5 class="text-muted text-uppercase fs-13">Members Registration <i
                                                ...
                                                <div class="d-flex align-items-center">
                                                      ...
                                                      <div class="flex-grow-1 ms-3">
                                                            <h2 class="mb-0">
                                                                  <span class="counter-value" data-target="{{ $activeMembersCount }}">0</span>
                                                            </h2>
                                                      </div>
                                                </div>
                                          </div>
                                    ...
                                    <li class="list-group-item ps-0">
                                          <div class="d-flex align-items-start">
                                                ...
                                                <div class="flex-grow-1">
                                                      ...
                                                      and documentation for lionsclubs admin</label>
                                                </div>
                                                <div class="flex-shrink-0 ms-2">
                                                      <p class="text-muted fs-12 mb-0">27 Sep, 2021</p>
                                                </div>
